export const portfolio = {
  ...
  projects: [
    ...
    { title: "UK Homelessness Support Data Pipeline", description: "Built a data pipeline to collect, clean, and structure homelessness-related data for analysis and reporting. Focused on transforming inconsistent source data into usable datasets for decision-making.", stack: ["Python", "BeautifulSoup", "Requests", "JSON"], github: "Coming soon" },
    { title: "Self Hosted Remote Development Environment", description: "Designed and deployed a self-hosted development environment to enable remote coding, testing, and deployment. Focused on improving development flexibility and system reliability.", stack: ["Linux", "WSL", "Bash", "Cloudflare"], github: "Coming soon" },
    { title: "Opportunity DecisionAI", description: "Developed an AI-assisted decision support tool to help evaluate opportunities based on structured inputs and data-driven insights.", stack: ["React", "Next.js", "TypeScript", "SQL"], github: "Coming soon" },
    { title: "Power Platform Automation", description: "Built workflow automations using Power Platform to reduce manual processes, improve efficiency, and integrate data across systems.", stack: ["Power Apps", "Power Automate", "Power BI"], github: "Coming soon" },
  ],
